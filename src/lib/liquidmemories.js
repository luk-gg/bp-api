import LIQUID_MEMORY from "../../game/api/bno/liquid_memory.json";
import LIQUID_MEMORY_ACCUMULATE_LOTTERY_TABLE from "../../game/api/bno/liquid_memory_accumulate_lottery_table.json";
