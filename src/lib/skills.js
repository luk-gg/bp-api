import SKILL_DATA from "../../game/api/bno/skill_data.json";
import AnimationCancels from "../../game/client/skill_animation_cancels.json";
import BP_BattleStatusManager from "../../game/client/bno/Content/Blueprints/Manager/BP_BattleStatusManager.json" // connects BattleEffectiveGroup to buff icon types
import DT_AbilityDB from "../../game/client/bno/Content/Blueprints/Manager/DT_AbilityDB.json" // connects buff id strings to icons
import BufIconDataTable from "../../game/client/bno/Content/Blueprints/UI/FocusTarget/SubWIdget/BufIconDataTable.json" // contains id strings for buff text
import StatusAlimentNotify from "../../game/client/bno/Content/Text/StatusAlimentNotify.json"
import DT_AttackMasterDataModifierDB from "../../game/client/bno/Content/Blueprints/Manager/DT_AttackMasterDataModifierDB.json" // contains debuffs applied on attack hit (i.e. Celeste Pillar G4)
...
const StatusAilmentDTs = Object.values(import.meta.glob('../../game/client/bno/Content/Blueprints/Magic/P[^/]+/[^/]+StatusAlimentConfig\.json', { import: "default", eager: true }))
    .flat()
...
const ProjectileDTs =
    Object.values(import.meta.glob('../../game/client/bno/Content/Blueprints/Magic/P[^/]+/[^/]+ProjectileConfigInfo\.json', { import: "default", eager: true }))
        .flat()
        .reduce((acc, configFile) => {
...
async function getSkillDTs() {
    ...
    const files = Object.values(import.meta.glob('../../game/client/bno/Content/Blueprints/Player/(Skill|PassiveSkill)/*/DT_*.json', { import: "default", eager: true })).flat()
